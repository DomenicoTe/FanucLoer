...
public class Focas1
{
    ...
    public class ODBST2
    {
        ...
        public short alarm;     /* alarm status */
        public short edit;      /* editting status */
        public short warning;   /* Status of wraning */
        public short o3dchk;    /* Status of 3D interference mode   */
        public short ext_opt;   /* Status of option                 */
        public short restart;   /* Status of restart after program editing */
    }
#endif
    ...
    {
        public ulong size;           /* ƒtƒ@ƒCƒ‹ƒTƒCƒY(byte) */
        public byte min;           /* ƒ^ƒCƒ€ƒXƒ^ƒ“ƒv(•ª) */
        public byte hour;          /* ƒ^ƒCƒ€ƒXƒ^ƒ“ƒv(Žž) */
        public byte day;           /* ƒ^ƒCƒ€ƒXƒ^ƒ“ƒv(“ú) */
        public byte month;         /* ƒ^ƒCƒ€ƒXƒ^ƒ“ƒv(ŒŽ) */
        public ushort year;          /* ƒ^ƒCƒ€ƒXƒ^ƒ“ƒv(”N) */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
    ...
    /* read CNC status information2 */
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_statinfo2")]
    public static extern short cnc_statinfo2(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBST2 a);
    ...
    /* allocate library security NEW */
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_allclibhndls")]
    public static extern short cnc_allclibhndls([In, MarshalAs(UnmanagedType.AsAny)] Object ip, ushort port, string accesscode, int timeout, out ushort FlibHndl);
